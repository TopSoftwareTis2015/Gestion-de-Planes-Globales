...
drop index ELEMENTOS_PK;

drop table ELEMENTOS;

drop index RELATIONSHIP_31_FK;

drop index ELEMENTOS_BASICOS_PK;

drop table ELEMENTOS_BASICOS;
...
drop index LISTA_ELEMENTOS_BASICOS_PK;

drop table LISTA_ELEMENTOS_BASICOS;
...
drop index RELACION_ELEMENTOS_PK;

drop table RELACION_ELEMENTOS;

drop index RELATIONSHIP_30_FK;

drop index SECCIONES_PK;
...
create table BIBLIOGRAFIAS (
   ...
   NUMERO_BIBLIOGRAFIA  INT4                 not null,
...
create table ELEMENTOS (
   ...
   ID_TIPO_ELEMENTO     INT4                 null,
   ID_BASICO            INT4                 null,
   TITULO_ELEMENTO      VARCHAR(100)         null,
   REQUIRED             VARCHAR(20)          null,
   NUMERO_ELEMENTO      INT4                 null,
...
/*==============================================================*/
create  index RELATIONSHIP_33_FK on ELEMENTOS (
ID_TIPO_ELEMENTO
);
...
/*==============================================================*/
create  index RELATIONSHIP_36_FK on ELEMENTOS (
ID_BASICO
);

/*==============================================================*/
/* Table: ELEMENTOS_BASICOS                                     */
/*==============================================================*/
create table ELEMENTOS_BASICOS (
   ID_BASICO            SERIAL               not null,
   ID                   INT4                 null,
   NUMERO_ELEMENTO_BASICO INT4                 null,
   constraint PK_ELEMENTOS_BASICOS primary key (ID_BASICO)
);

/*==============================================================*/
/* Index: ELEMENTOS_BASICOS_PK                                  */
/*==============================================================*/
create unique index ELEMENTOS_BASICOS_PK on ELEMENTOS_BASICOS (
ID_BASICO
);
...
/*==============================================================*/
create  index RELATIONSHIP_31_FK on ELEMENTOS_BASICOS (
ID
);
...
create table FACULTADES (
   CODIGO_FACULTAD      SERIAL               not null,
...
/*==============================================================*/
/* Table: LISTA_ELEMENTOS_BASICOS                               */
/*==============================================================*/
create table LISTA_ELEMENTOS_BASICOS (
   ID_LISTA_ELEMENTOS_BASICOS SERIAL               not null,
   NUMERO_ELEMENTO_LISTA INT4                 null,
   constraint PK_LISTA_ELEMENTOS_BASICOS primary key (ID_LISTA_ELEMENTOS_BASICOS)
);

/*==============================================================*/
/* Index: LISTA_ELEMENTOS_BASICOS_PK                            */
/*==============================================================*/
create unique index LISTA_ELEMENTOS_BASICOS_PK on LISTA_ELEMENTOS_BASICOS (
ID_LISTA_ELEMENTOS_BASICOS
);
...
/*==============================================================*/
/* Table: RELACION_ELEMENTOS                                    */
/*==============================================================*/
create table RELACION_ELEMENTOS (
   ID_BASICO            INT4                 not null,
   ID_LISTA_ELEMENTOS_BASICOS INT4                 null,
   constraint PK_RELACION_ELEMENTOS primary key (ID_BASICO)
);

/*==============================================================*/
/* Index: RELACION_ELEMENTOS_PK                                 */
/*==============================================================*/
create unique index RELACION_ELEMENTOS_PK on RELACION_ELEMENTOS (
ID_BASICO
);
...
/*==============================================================*/
create  index RELATIONSHIP_35_FK on RELACION_ELEMENTOS (
ID_LISTA_ELEMENTOS_BASICOS
);
...
create table SECCIONES (
   ID                   SERIAL               not null,
   ID_PG                INT4                 null,
   TITULO_PRINCIPAL_SECCION VARCHAR(100)         null,
...
/* Index: SECCIONES_PK                                          */
/*==============================================================*/
create unique index SECCIONES_PK on SECCIONES (
ID
);
...
/*==============================================================*/
create  index RELATIONSHIP_30_FK on SECCIONES (
ID_PG
);
...
create table TIPO_ELEMENTO (
   ID_TIPO_ELEMENTO     INT4                 not null,
   CLASE_ELEMENTO       VARCHAR(100)         null,
   constraint PK_TIPO_ELEMENTO primary key (ID_TIPO_ELEMENTO)
);

/*==============================================================*/
/* Index: TIPO_ELEMENTO_PK                                      */
/*==============================================================*/
create unique index TIPO_ELEMENTO_PK on TIPO_ELEMENTO (
ID_TIPO_ELEMENTO
);
...
create table UNIDAD (
   ...
   DURACION_SEMANAS     FLOAT8               null,
   NUMERO_UNIDAD        INT4                 null,
...
alter table ELEMENTOS
   add constraint FK_ELEMENTO_RELATIONS_TIPO_ELE foreign key (ID_TIPO_ELEMENTO)
      references TIPO_ELEMENTO (ID_TIPO_ELEMENTO)
      on delete restrict on update restrict;

alter table ELEMENTOS
   add constraint FK_ELEMENTO_RELATIONS_RELACION foreign key (ID_BASICO)
      references RELACION_ELEMENTOS (ID_BASICO)
      on delete restrict on update restrict;

alter table ELEMENTOS_BASICOS
   add constraint FK_ELEMENTO_RELATIONS_SECCIONE foreign key (ID)
...
alter table PLAN_DE_ESTUDIOS
   add constraint FK_PLAN_DE__RELATIONS_CARRERAS foreign key (CODIGO_CARRERA)
...
alter table RELACION_ELEMENTOS
   add constraint FK_RELACION_RELATIONS_ELEMENTO foreign key (ID_BASICO)
      references ELEMENTOS_BASICOS (ID_BASICO)
      on delete restrict on update restrict;

alter table RELACION_ELEMENTOS
   add constraint FK_RELACION_RELATIONS_LISTA_EL foreign key (ID_LISTA_ELEMENTOS_BASICOS)
      references LISTA_ELEMENTOS_BASICOS (ID_LISTA_ELEMENTOS_BASICOS)
      on delete restrict on update restrict;
