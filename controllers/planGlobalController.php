...
class planGlobalController extends Controller{
    ...
    public function contenidoMinimo($id_pg){
        // contenido minimo
        $id = $id_pg[0];
		$planGlobal = $this->_planGlobalDao->getPlanGlobal($id);
		...
		// $this->_view->materia = $this->_materiaDao->getMateriaPlanGlobal($id);
		
		// $this->_view->gruposTotales = $this->_grupoDao->getGruposSinPG($this->_view->materia['codigo_materia']);
		// $this->_view->gruposPlanGlobal = $this->_grupoDao->getGruposPG($id, $this->_view->materia['codigo_materia']);

		// $this->_view->docentesTotales = $this->_grupoDao->getDocentesSinPG($this->_view->materia['codigo_materia']);
		// $this->_view->docentesPlanGlobal = $this->_grupoDao->getDocentesPG($id, $this->_view->materia['codigo_materia']);

		// $this->_view->carga_horaria = $this->_planGlobalDao->getCargaHoraria($id);
