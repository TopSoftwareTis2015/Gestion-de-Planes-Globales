...
<legend id="separador"><h3>OBJETIVOS GENERALES</h3></legend> <!--campos para ingresar los objetivos generales -->
  <form name="formPg3" method="POST" action="">
    <div class="container-fluid" id="objG1">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="tituloObjG1" type="text" id="titulo">
        </div>
        
        <!--campo para la descripcion del objetivo general-->
        <div class="form-group">
          <label for="descripcion">Descripcion:</label>
          <textarea class="form-control" name="descripcionObjG1" id="descripcion" cols="100" rows="5"></textarea>
        </div>
    ...
    <div class="container-fluid" id="objE1">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="tituloObjE1" type="text" id="titulo">
        </div>

        <!--descripcion del objetivo especifico-->
        <div class="form-group">
          <label for="codigo">Descripcion:</label>
          <textarea class="form-control" name="descripcionObjE1" cols="100" rows="5"></textarea>
        </div>
      </fieldset>    
    </div>
